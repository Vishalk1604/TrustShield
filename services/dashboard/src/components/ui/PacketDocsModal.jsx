  ...
  return (
    <div onClick={onClose} role="dialog" aria-modal="true"
      ...
      <div onClick={(e) => e.stopPropagation()}
        style={{ width: "min(960px, 96vw)", maxHeight: "94vh", overflow: "auto", maxWidth,
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, padding: "13px 18px",
          ...
          {hasMark && <Badge c={m.hue}>{m.label}{d.finding && DETECTOR_LABEL ? "" : ""}</Badge>}
          <span style={{ flex: 1 }} />
        ...
        <div style={{ padding: "12px 18px 18px" }}>
          <BoxedImage src={d.img} alt={label} boxes={boxes} imgW={d.w} imgH={d.h} hue={m.hue}
            label={boxes.length ? "detected edit" : null} style={{ maxHeight: "66vh", margin: "0 auto" }} />
          ...
          {hasMark && d.finding && (
            <div style={{ marginTop: 12, borderLeft: `2px solid ${hexA(m.hue, 0.6)}`, paddingLeft: 12, maxWidth: 720, margin: "12px auto 0" }}>
