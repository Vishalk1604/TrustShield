...
def main() -> int:
    ...
    for f in PUB_DEMO.glob("PKT-*.png"):
        f.unlink()
    ...
    for pid in PACKET_IDS:
        ...
        out[pid] = {"decision": dec, "subgraph": subgraph, "overlays": overlays}
        print(f"  {pid}: {dec['recommendation']['action']:14s} trust={dec['trust_score']['overall']:.1f} overlays={len(overlays)}")
